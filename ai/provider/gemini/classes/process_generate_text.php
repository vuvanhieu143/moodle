 ...
 */
class process_generate_text extends gemini_base_processor {
    ...
    protected function create_request_object(string $userid): RequestInterface {
        ...
        $config = $this->action->get_configuration();
        ...
        $body = [
                ...
                'generationConfig' => $this->build_generation_config($config),
                'responseModality' => $this->get_modalities_for_action(),
                'labels' => ['userid' => $userid]
        ];

        $system = $this->get_system_instruction();
        if (!empty($system)) {
