...
$string['enableglobalratelimit_help'] = 'Limit the number of requests that the AI provider can receive across the entire site.';
$string['enableuserratelimit'] = 'Set user rate limit';
$string['enableuserratelimit_help'] = 'Limit the number of requests each user can make to the AI provider.';
...
$string['error:429:internalsitewide'] = 'AI has reached the maximum number of site-wide requests per hour. Try again later';
