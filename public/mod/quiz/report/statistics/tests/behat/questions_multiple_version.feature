...
Feature: Advance use of the Statistics report
  ...
  @javascript
  Scenario: Report with multiple random questions from the same category with multiple versions.
    Given the following "questions" exist:
      | questioncategory | qtype       | template    | name            | questiontext |
      | Test questions   | multichoice | one_of_four | Test question 1 |              |
      | Test questions   | multichoice | one_of_four | Test question 2 |              |
      | Test questions   | multichoice | one_of_four | Test question 3 |              |
    And quiz "Quiz 1" contains the following questions:
      | question                | page | randomcategory |
      | Random (Test questions) | 1    | Test questions |
      | Random (Test questions) | 1    | Test questions |
    ...
    And the following "core_question > updated questions" exist:
      | questioncategory | question        | name               |
      | Test questions   | Test question 1 | Question updated 1 |
      | Test questions   | Test question 2 | Question updated 2 |
      | Test questions   | Test question 3 | Question updated 3 |
    And user "student1" has attempted "Quiz 1" with responses:
      | slot | response |
      | 1    | One      |
      | 2    | One      |
    ...
    And "2" row "Question name" column of "questionstatistics" table should contain "Random question"
    And I click on "a[href*='slot=1']" "css_element"
    And I should see "Structural analysis for question number 1"
    And I am on the "Quiz 1" "mod_quiz > Statistics report" page logged in as teacher1
    And I set the field "Calculate statistics from" to "all attempts"
    And I press "Show report"
    And I click on "a[href*='slot=2']" "css_element"
    And I should see "Structural analysis for question number 2"
